...
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class HeroAnimatingVideosCard extends StatelessWidget {
  const HeroAnimatingVideosCard({
...
/// This is an example of a custom widget that an app developer might create for
/// use on both iOS and Android as part of their brand's unique design.
class VideosPlaceholderTile extends StatelessWidget {
  const VideosPlaceholderTile({Key? key}) : super(key: key);
